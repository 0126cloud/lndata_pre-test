...
const SearchForm = props => {
    ...
    const { totalTeam, searchKey, setSearchKey, handleSearch, setSearchTeam, searchTeam, setCurrentPage } = props
        ...
        <MDBCol>
            ...
            <MDBCol md="3" className="d-flex align-items-center mt-2">
                ...
                <select style={{borderRadius: "2px"}} className="browser-default custom-select" 
                        aria-describedby="basic-select" onChange={(event) => {
                            setCurrentPage(1)
            ...
            <MDBCol md="3" className="d-flex align-items-center mt-2">
                ...
                <input type="text" style={{borderRadius: "2px"}} 
                       ...
                       aria-describedby="basic-addon" onChange={(event) => {
                           setCurrentPage(1)
            ...
            <MDBBtn className="px-3 py-2 mt-5"
               onClick={()=> handleSearch(searchKey, searchTeam)}>Search</MDBBtn>
